namespace Odusseus.RulesTests
{
    ...
    public class CoreTest
    {
        ...
        public void Evaluate_1()
        {
            ...
            // Assert
            core.Group.Answers["R3"].Should().Be(Answer.Yes, "True && True => Yes");
        }
        ...
        public void Evaluate_1A()
        {
            ...
            // Assert
            core.Group.Answers["R3"].Should().Be(Answer.No, "! True && True => No");
        }
        ...
        public void Evaluate_1C()
        {
            ...
            // Assert
            core.Group.Answers["R3"].Should().Be(Answer.No, "! True && ! True => False");
        }
        ...
        public void Evaluate_3()
        {
            ...
            // Assert
            core.Group.Answers["R3"].Should().Be(Answer.No, "False && True => False");
        }
        ...
        public void Evaluate_4()
        {
            ...
            // Assert
            core.Group.Answers["R3"].Should().Be(Answer.Yes, "False || True => True");
        }
        ...
        public void Evaluate_5()
        {
            ...
            // Assert
            core.Group.Answers["R3"].Should().Be(Answer.No, "False || False => False");
        }
        ...
        public void Evaluate_6()
        {
            ...
            // Assert
            core.Group.Answers["R4"].Should().Be(Answer.Yes, "True && True && True=> True");
        }
        ...
        public void Evaluate_7()
        {
            ...
            // Assert
            core.Group.Answers["R4"].Should().Be(Answer.No, "True && True && False => False");
        }
        ...
        public void Evaluate_8()
        {
            ...
            // Assert
            core.Group.Answers["R4"].Should().Be(Answer.No, "True && False && False => False");
        }
        #endregion Evaluate
        ...
        public void Evaluate_L0501()
        {
            ...
            // Assert
            core.Group.Answers["R5"].Should().Be(Answer.Yes, "(True && True) => True ( True && True ) => True");
        }
        ...
        public void Evaluate_L0502()
        {
            ...
            // Assert
            core.Group.Answers["R5"].Should().Be(Answer.No, "(True && False) => False ( False && True ) => False");
        }
        ...
        public void Evaluate_L0504()
        {
            ...
            // Assert
            core.Group.Answers["R7"].Should().Be(Answer.Yes, "R1 && R5 && R7 => True");
        }
        ...
        public void Evaluate_L0505()
        {
            ...
            // Assert
            core.Group.Answers["R7"].Should().Be(Answer.No, "R1 && R5 && R7 => False");
        }
        #endregion Level 5
